...
CREATE TABLE tx_cartevents_domain_model_eventdate (
    ...
    price_categorized tinyint(4) unsigned DEFAULT '0' NOT NULL,
    price double(11,2) DEFAULT '0.00' NOT NULL,
    special_prices int(11) unsigned DEFAULT '0' NOT NULL,
    price_categories int(11) unsigned DEFAULT '0' NOT NULL,

    handle_seats tinyint(4) unsigned DEFAULT '0' NOT NULL,
    handle_seats_in_price_category tinyint(4) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_cartevents_domain_model_pricecategory'
#
CREATE TABLE tx_cartevents_domain_model_pricecategory (
    uid int(11) NOT NULL auto_increment,
    pid int(11) DEFAULT '0' NOT NULL,
