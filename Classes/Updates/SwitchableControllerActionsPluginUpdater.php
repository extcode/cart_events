...
class SwitchableControllerActionsPluginUpdater implements UpgradeWizardInterface
{
    private const MIGRATION_SETTINGS = [
        [
            'sourceListType' => 'cartevents_events',
            'switchableControllerActions' => 'Event->show;Event->list',
            'targetListType' => 'cartevents_listevents',
        ],
        [
            'sourceListType' => 'cartevents_events',
            'switchableControllerActions' => 'Event->show',
            'targetListType' => 'cartevents_showevent',
        ],
    ];
    ...
    {
        return 'The old Cart: Events plugin using switchableControllerActions has been split into 2 separate plugins. '
